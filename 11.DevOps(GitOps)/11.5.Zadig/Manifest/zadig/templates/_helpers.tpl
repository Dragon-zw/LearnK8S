...
{{- define "zadig.microservice.user.grpcport" -}}
8080
{{- end }}
...
{{- define "zadig.redis.labels" -}}
app.kubernetes.io/component: redis
{{ include "zadig.labels" . }}
{{- end }}

{{- define "zadig.redis.selectorLabels" -}}
app.kubernetes.io/component: redis
{{ include "zadig.selectorLabels" . }}
{{- end }}
...
{{/*
=====================================================
=            PLUTUS VENDOR MICROSERVICE SETTINGS             =
=====================================================
*/}}

{{- define "zadig.microservice.plutus-vendor.labels" -}}
app.kubernetes.io/component: plutus-vendor
{{ include "zadig.labels" . }}
{{- end }}
...
Selector labels
*/}}
{{- define "zadig.microservice.plutus-vendor.selectorLabels" -}}
app.kubernetes.io/component: plutus-vendor
{{ include "zadig.selectorLabels" . }}
{{- end }}
...
{{/*
=====================================================
=            VENDOR PORTAL MICROSERVICE SETTINGS             =
=====================================================
*/}}

{{- define "zadig.microservice.vendor-portal.labels" -}}
app.kubernetes.io/component: vendor-portal
{{ include "zadig.labels" . }}
{{- end }}

{{- define "zadig.microservice.vendor-portal.selectorLabels" -}}
app.kubernetes.io/component: vendor-portal
{{- end }}
...
=====================================================
*/}}
{{- define "zadig.time.nlp.labels" -}}
app.kubernetes.io/component: time-nlp
{{ include "zadig.labels" . }}
{{- end }}

{{- define "zadig.time.nlp.port" -}}
8000
{{- end }}

{{- define "zadig.time.nlp.selectorLabels" -}}
app.kubernetes.io/component: time-nlp
{{ include "zadig.selectorLabels" . }}
{{- end }}